...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Course',
            fields=[
                ('CourseUUID', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Subject',
            fields=[
                ('SubjectUUID', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('SubjectID', models.CharField(default='XXXXX', max_length=20, verbose_name='Subject ID')),
                ('SubjectName', models.CharField(default='XXXXX', max_length=100, verbose_name='Subject Name')),
                ('SubjectDescription', models.TextField(default='XXXXX', verbose_name='Subject Description')),
            ],
        ),
        migrations.CreateModel(
            name='Subject_Admin',
